...
return (new CustomEvent(event_name,(function (){var obj42825 = {"detail":data};
return obj42825;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__30470__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__30470__auto__)){
var and__30470__auto____$1 = (window["CustomEvent"]);
...
var args42830 = [];
var len__31595__auto___42836 = arguments.length;
var i__31596__auto___42837 = (0);
while(true){
if((i__31596__auto___42837 < len__31595__auto___42836)){
args42830.push((arguments[i__31596__auto___42837]));

var G__42838 = (i__31596__auto___42837 + (1));
i__31596__auto___42837 = G__42838;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args42830.length)].join('')));
...
var f = (function (){var pred__42833 = cljs.core._EQ_;
var expr__42834 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__42833.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__42834))){
return ((function (pred__42833,expr__42834){
return (function (p1__42826_SHARP_){
return console.warn(p1__42826_SHARP_);
});
;})(pred__42833,expr__42834))
} else {
if(cljs.core.truth_(pred__42833.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__42834))){
return ((function (pred__42833,expr__42834){
return (function (p1__42827_SHARP_){
return console.debug(p1__42827_SHARP_);
});
;})(pred__42833,expr__42834))
} else {
if(cljs.core.truth_(pred__42833.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__42834))){
return ((function (pred__42833,expr__42834){
return (function (p1__42828_SHARP_){
return console.error(p1__42828_SHARP_);
});
;})(pred__42833,expr__42834))
} else {
return ((function (pred__42833,expr__42834){
return (function (p1__42829_SHARP_){
return console.log(p1__42829_SHARP_);
});
;})(pred__42833,expr__42834))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__42840){
var map__42843 = p__42840;
...
var eval_fn = cljs.core.get.call(null,map__42843__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__42845_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__42847,(0),null);
var v = cljs.core.nth.call(null,vec__42847,(1),null);
...
var args42850 = [];
var len__31595__auto___42853 = arguments.length;
var i__31596__auto___42854 = (0);
while(true){
if((i__31596__auto___42854 < len__31595__auto___42853)){
args42850.push((arguments[i__31596__auto___42854]));

var G__42855 = (i__31596__auto___42854 + (1));
i__31596__auto___42854 = G__42855;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args42850.length)].join('')));
...
if(cljs.core.truth_((function (){var and__30470__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1497293637531