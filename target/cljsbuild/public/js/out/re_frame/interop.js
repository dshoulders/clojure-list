...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__36507 = cljs.core.instance_QMARK_;
var expr__36508 = reactive_val;
if(cljs.core.truth_(pred__36507.call(null,reagent.ratom.RAtom,expr__36508))){
return "ra";
} else {
if(cljs.core.truth_(pred__36507.call(null,reagent.ratom.RCursor,expr__36508))){
return "rc";
} else {
if(cljs.core.truth_(pred__36507.call(null,reagent.ratom.Reaction,expr__36508))){
return "rx";
} else {
if(cljs.core.truth_(pred__36507.call(null,reagent.ratom.Track,expr__36508))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1497293537618