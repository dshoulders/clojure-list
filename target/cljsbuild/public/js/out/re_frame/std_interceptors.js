...
var vec__37005_37008 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_37009 = cljs.core.nth.call(null,vec__37005_37008,(0),null);
var only_after_37010 = cljs.core.nth.call(null,vec__37005_37008,(1),null);
var db_changed_QMARK__37011 = (!((only_before_37009 == null))) || (!((only_after_37010 == null)));
if(db_changed_QMARK__37011){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_37009);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_37010);
...
var map__37018 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.call(null,map__37018__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__37018__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__37026 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__37026__$1;
var event = cljs.core.get.call(null,map__37026__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__31595__auto___37029 = arguments.length;
var i__31596__auto___37030 = (0);
while(true){
if((i__31596__auto___37030 < len__31595__auto___37029)){
args__31602__auto__.push((arguments[i__31596__auto___37030]));

var G__37031 = (i__31596__auto___37030 + (1));
i__31596__auto___37030 = G__37031;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__31603__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq37028){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq37028));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__30482__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__31602__auto__ = [];
var len__31595__auto___37037 = arguments.length;
var i__31596__auto___37038 = (0);
while(true){
if((i__31596__auto___37038 < len__31595__auto___37037)){
args__31602__auto__.push((arguments[i__31596__auto___37038]));

var G__37039 = (i__31596__auto___37038 + (1));
i__31596__auto___37038 = G__37039;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__31603__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__37032_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__37033_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__37033_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq37034){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__37035,G__37036,seq37034__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1497293539279