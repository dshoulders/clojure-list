...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__31093__auto__,writer__31094__auto__,opt__31095__auto__){
return cljs.core._write.call(null,writer__31094__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__32159 = o;
(G__32159[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__32160__delegate = function (args){
...
while (G__32161__i < G__32161__a.length) {G__32161__a[G__32161__i] = arguments[G__32161__i + 0]; ++G__32161__i;}
  args = new cljs.core.IndexedSeq(G__32161__a,0,null);
} 
return G__32160__delegate.call(this,args);};
G__32160.cljs$lang$maxFixedArity = 0;
G__32160.cljs$lang$applyTo = (function (arglist__32162){
var args = cljs.core.seq(arglist__32162);
return G__32160__delegate(args);
});
...
if(cljs.core.truth_((function (){var and__30470__auto__ = !((jsprops == null));
if(and__30470__auto__){
var and__30470__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__32167 = jsprops;
(G__32167["defaultValue"] = value);

(G__32167["onChange"] = ((function (G__32167,v,value,on_change){
return (function (p1__32165_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__32165_SHARP_);
});})(G__32167,v,value,on_change))
);
...
var vec__32174 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__32174,(0),null);
var id = cljs.core.nth.call(null,vec__32174,(1),null);
var class$ = cljs.core.nth.call(null,vec__32174,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___32179 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___32179 == null)){
} else {
var key_32180 = temp__4661__auto___32179;
(jsprops["key"] = key_32180);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__32182 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__32182["name"] = c);
...
var len__31595__auto___32188 = arguments.length;
var i__31596__auto___32189 = (0);
while(true){
if((i__31596__auto___32189 < len__31595__auto___32188)){
args__31602__auto__.push((arguments[i__31596__auto___32189]));

var G__32190 = (i__31596__auto___32189 + (1));
i__31596__auto___32189 = G__32190;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__31603__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq32186){
var G__32187 = cljs.core.first.call(null,seq32186);
var seq32186__$1 = cljs.core.next.call(null,seq32186);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__32187,seq32186__$1);
});
...
break;
default:
var G__32194 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__32194;
continue;
...
var n__31405__auto___32197 = a.length;
var i_32198 = (0);
while(true){
if((i_32198 < n__31405__auto___32197)){
(a[i_32198] = reagent.impl.template.as_element.call(null,(a[i_32198])));

var G__32199 = (i_32198 + (1));
i_32198 = G__32199;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__31405__auto___32200 = a.length;
var i_32201 = (0);
while(true){
if((i_32201 < n__31405__auto___32200)){
var val_32202 = (a[i_32201]);
if((cljs.core.vector_QMARK_.call(null,val_32202)) && ((reagent.impl.template.key_from_vec.call(null,val_32202) == null))){
(o["no-key"] = true);
} else {
}

(a[i_32201] = reagent.impl.template.as_element.call(null,val_32202));

var G__32203 = (i_32201 + (1));
i_32201 = G__32203;
continue;
} else {
}
...
var ctx = ({});
var vec__32207 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__32207,(0),null);
var derefed = cljs.core.nth.call(null,vec__32207,(1),null);
...
var G__32211 = (cljs.core.count.call(null,argv) - first_child);
switch (G__32211) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__32211){
...
//# sourceMappingURL=template.js.map?rel=1497293532316